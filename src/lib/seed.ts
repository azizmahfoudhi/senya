...
export function demoSeed(): FarmState {
  const typeKor = { id: uuid(), nom: "Koroneiki", rendementMaxKgParArbre: 45, isIntensive: true };
  const typeChe = { id: uuid(), nom: "Chemlali", rendementMaxKgParArbre: 60, isIntensive: false };
